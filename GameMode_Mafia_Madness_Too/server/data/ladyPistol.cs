...
$MM::LoadedGun_LadyPistol = true;

$MM::GunItem[$MM::GunItems] = "LadyPistolItem";
$MM::GunItems++;

datablock ItemData(LadyPistolItem)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./ladyPistol.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
...
datablock ShapeBaseImageData(LadyPistolImage)
{
   // Basic Item properties
   shapeFile = "./ladyPistol.dts";
   emap = true;
...
function LadyPistolImage::onFire(%this, %obj, %slot)
{
	MMGunImage::onFire(%this, %obj, %slot);
}

function LadyPistolImage::onReady(%this,%obj,%slot)
{
	MMGunImage::onReady(%this, %obj, %slot);
}

function LadyPistolImage::onReloaded(%this, %obj, %slot)
{
	MMGunImage::onReloaded(%this, %obj, %slot);
}

function LadyPistolImage::onReloadStart(%this, %obj, %slot)
{
	MMGunImage::onReloadStart(%this, %obj, %slot);
}

function LadyPistolImage::onReloadMid(%this, %obj, %slot)
{
