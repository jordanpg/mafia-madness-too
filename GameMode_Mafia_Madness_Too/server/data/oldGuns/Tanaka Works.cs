$MM::GunItem[$MM::GunItems] = "MMTanakaItem";
$MM::GunItems++;

datablock ProjectileData(MMTanakaProjectile)
{
...
datablock ItemData(MMTanakaItem)
{
...
datablock ShapeBaseImageData(MMTanakaImage)
{
   // Basic Item properties
   shapeFile = "./Tanaka Works.dts";
   emap = true;
