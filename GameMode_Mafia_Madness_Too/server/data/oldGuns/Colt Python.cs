$MM::GunItem[$MM::GunItems] = "MMPythonItem";
$MM::GunItems++;

datablock ProjectileData(MMPythonProjectile)
{
...
datablock ItemData(MMPythonItem)
{
...
datablock ShapeBaseImageData(MMPythonImage)
{
   // Basic Item properties
   shapeFile = "./Colt Python.dts";
   emap = true;
