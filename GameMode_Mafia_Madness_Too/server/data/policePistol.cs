...
$MM::LoadedGun_PolicePistol = true;

$MM::GunItem[$MM::GunItems] = "PolicePistolItem";
$MM::GunItems++;

datablock ItemData(PolicePistolItem)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./PolicePistol.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
...
datablock ShapeBaseImageData(PolicePistolImage)
{
   // Basic Item properties
   shapeFile = "./PolicePistol.dts";
   emap = true;
...
function PolicePistolImage::onFire(%this, %obj, %slot)
{
	MMGunImage::onFire(%this, %obj, %slot);
}

function PolicePistolImage::onReady(%this,%obj,%slot)
{
	MMGunImage::onReady(%this, %obj, %slot);
}

function PolicePistolImage::onReloaded(%this, %obj, %slot)
{
	MMGunImage::onReloaded(%this, %obj, %slot);
}

function PolicePistolImage::onReloadStart(%this, %obj, %slot)
{
	MMGunImage::onReloadStart(%this, %obj, %slot);
}

function PolicePistolImage::onReloadMid(%this, %obj, %slot)
{
