...
$MM::LoadedGun_DirtyHarry = true;

$MM::GunItem[$MM::GunItems] = "DirtyHarryItem";
$MM::GunItems++;

datablock ItemData(DirtyHarryItem)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./dirtyHarry.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
...
datablock ShapeBaseImageData(DirtyHarryImage)
{
   // Basic Item properties
   shapeFile = "./dirtyHarry.dts";
   emap = true;
...
function DirtyHarryImage::onFire(%this, %obj, %slot)
{
	MMGunImage::onFire(%this, %obj, %slot);
}

function DirtyHarryImage::onReady(%this,%obj,%slot)
{
	MMGunImage::onReady(%this, %obj, %slot);
}

function DirtyHarryImage::onReloaded(%this, %obj, %slot)
{
	MMGunImage::onReloaded(%this, %obj, %slot);
}

function DirtyHarryImage::onReloadStart(%this, %obj, %slot)
{
	MMGunImage::onReloadStart(%this, %obj, %slot);
}

function DirtyHarryImage::onReloadMid(%this, %obj, %slot)
{
